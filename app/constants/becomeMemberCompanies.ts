...
const companyBiosByKey: Record<string, CompanyBio> = {
  ...
  wildberries: {
    en: 'Wildberries is one of the largest online platforms in the Eurasian region, operating in ten countries and connecting buyers with manufacturers. The company’s main goal is to support local businesses and promote export development.',
    ru: 'Wildberries — одна из крупнейших онлайн-платформ Евразийского региона, работающая в десяти странах и соединяющая покупателей с производителями. Главная цель компании — поддержка местного бизнеса и развитие экспорта.',
    uz: 'Wildberries — Yevroosiyo mintaqasidagi eng yirik onlayn platformalardan biri bo‘lib, o‘n mamlakatda faoliyat yuritadi va xaridorlarni ishlab chiqaruvchilar bilan bog‘laydi. Kompaniyaning asosiy maqsadi — mahalliy bizneslarni qo‘llab-quvvatlash va eksportni rivojlantirish.',
  },
  kostalegal: {
...
export const becomeMemberCompanies = [
  ...
  { id: 'F-06', filename: 'calik-enerji.png', name: 'Calık Enerji', website: 'https://www.calikenerji.com' },
