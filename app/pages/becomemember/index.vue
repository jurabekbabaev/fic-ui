      ...
      <div id="membership-form" class="container">
        ...
        <div>
          ...
          <div>
            ...
            <ul class="ml-4">
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{
                  t("Объём инвестиций в Узбекистане (минимум 50 млн долл. США)")
                }}
              </li>
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{ t("Социальные проекты в Узбекистане") }}
              </li>
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{ t("Срок присутствия в Узбекистане") }}
              </li>
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{ t("Оплата членского взноса") }}
              </li>
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{
                  t(
                    "Вклад в развитие инвестиционной среды (экспертиза/финансирование)"
                  )
                }}
              </li>
            </ul>
          ...
          <div>
            ...
            <ul class="ml-4">
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{ t("Стратегические сектора деятельности") }}
              </li>
              <li
                class="list-decimal text-base text-[#505A63] font-normal mb-3"
              >
                {{ t("Количество созданных рабочих мест") }}
              </li>
            </ul>
          </div>
        </div>
