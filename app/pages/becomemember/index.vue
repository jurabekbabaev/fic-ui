    ...
    <client-only>
      <div id="membership-form" class="container">
        <div class="mt-[100px] mb-14 sm:text-left lg:text-center">
          ...
          >
            {{ t('СИИ — основная институциональная платформа для структурированного диалога между иностранными инвесторами и Правительством Узбекистана.') }}
          </h3>
        </div>
        ...
        <section class="mt-[50px]">
          ...
          <p class="mt-6 text-sm lg:text-base text-[#505A63] italic leading-relaxed">
            {{ t('Приём и форматы участия определяются в соответствии с Уставом, Положением о членстве и применимыми протокольными правилами.') }}
          </p>
        </section>
        ...
        <section class="mt-[60px] grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-5">
          <div class="bg-white border border-[#0000001A] rounded-2xl p-6 lg:p-8">
            ...
            <ul class="mt-6 space-y-4">
              ...
              >
                ...
                ></span>
                <span class="text-sm lg:text-base leading-relaxed text-[#505A63]">
                  {{ t(item) }}
                </span>
              </li>
            </ul>
