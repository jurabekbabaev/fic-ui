    ...
    <client-only>
      ...
      <div class="container">
        <p class="lg:max-w-[900px] w-full text-base lg:text-lg text-[#505A63] font-normal leading-[170%]">
          {{
            t(
              "Членами Совета иностранных инвесторов являются ведущие международные компании, банки и финансовые институты, осуществляющие стратегические инвестиции в экономику Узбекистана. Членство отражает долгосрочную приверженность развитию страны и предоставляет прямой канал диалога с Правительством по вопросам инвестиционной политики. Совет объединяет 43 члена из 19 стран, представляющих 23 сектора экономики.",
            )
          }}
        </p>
