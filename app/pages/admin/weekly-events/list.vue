...
<template>
  <div class="flex justify-between mb-4">
    <h1 class="text-[24px] font-medium">{{ t('admin.weeklyEvents.list') }}</h1>
    <div>
      <NuxtLink class="btn btn-primary btn-sm" to="/admin/weekly-events/create">{{ t('admin.addNew') }}</NuxtLink>
    </div>
  </div>
  <div class="x-table">
    <table>
