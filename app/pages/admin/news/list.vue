...
<template>
  <div class="flex justify-between mb-4">
    <h1 class="text-[24px] font-medium">{{ t('admin.news.list') }}</h1>
    <div>
      <NuxtLink class="btn btn-primary btn-sm" to="/admin/news/create">{{ t('admin.addNew') }}</NuxtLink>
    </div>
  </div>
  <div class="x-table">
    <table>
